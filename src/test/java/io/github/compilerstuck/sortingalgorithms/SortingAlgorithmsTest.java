...
class SortingAlgorithmsTest {
  ...
  /**
   * Provide every algorithm except for the deliberately pathological BogoSort. Each combination
   * will be executed with two different array sizes to increase confidence that the implementation
   * works for both small and moderately sized inputs.
   */
  static Stream<Arguments> algorithmAndSizes() {
    List<Class<? extends SortingAlgorithm>> algs =
        List.of(
            BubbleSort.class,
            SelectionSort.class,
            InsertionSort.class,
