...
/**
 * Static registry of all sorting algorithms available to the Settings UI,
 * in the order they were historically presented.
 */
public final class AlgorithmCatalog {
    ...
    private static AlgorithmDescriptor descriptor(String id, String displayName,
                                                    java.util.function.Function<io.github.compilerstuck.control.model.ArrayModel, SortingAlgorithm> ctor) {
        return new AlgorithmDescriptor(id, displayName, (array, proc) -> {
