...
/**
 * Abstraction over the Processing drawing API used by visualizations.
 * This interface exists so that rendering code can be tested or executed in a
 * headless environment without depending on a real {@code PApplet}.
 */
