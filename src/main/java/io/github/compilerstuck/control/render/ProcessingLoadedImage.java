...
/**
 * Adapter that exposes a Processing {@link PImage} as a {@link LoadedImage}.
 * Extends {@link PImage} so {@code MainController.loadImage} can covariantly
 * override {@code PApplet.loadImage} while returning this type.
 */
