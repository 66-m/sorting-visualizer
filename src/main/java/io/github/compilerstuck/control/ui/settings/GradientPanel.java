...
public final class GradientPanel {
  ...
  public GradientPanel(AppContext app) {
    ...
    gradientListComboBox.addActionListener(
        e -> {
          ...
          colorChoose2.setBackground(
              app.getColorGradient().getMarkerColor(app.getSize() - 1, Marker.NORMAL));
        });
    ...
    MouseListener ml =
        new java.awt.event.MouseAdapter() {
          ...
          public void mousePressed(MouseEvent e) {
            ...
            Color selectedColor =
                JColorChooser.showDialog(null, "Select Color", jPanel.getBackground());
