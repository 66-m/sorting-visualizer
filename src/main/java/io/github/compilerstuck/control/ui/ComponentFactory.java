...
/**
 * Factory for consistently styled, rounded UI components. All buttons use custom-painted rounded
 * rectangles for a modern 2025 look.
 */
public class ComponentFactory {
  ...
  /**
   * Primary action button — dark background, white text, rounded corners. Used for the main "RUN"
   * action — more prominence with larger font.
   */
  public static JButton createPrimaryButton(String text) {
    JButton btn =
        buildRoundedButton(
            text,
            UiTheme.BUTTON_PRIMARY,
            UiTheme.BUTTON_PRIMARY_FG,
            null,
            BUTTON_ARC,
  ...
  /** Secondary action button — white background, zinc border, dark text. Used for "Cancel", etc. */
  public static JButton createSecondaryButton(String text) {
    JButton btn =
        buildRoundedButton(
            text,
            UiTheme.BUTTON_SECONDARY,
  ...
  /**
   * Compact inline button for auxiliary actions (Apply, Configure, Select Image). Same visual style
   * as secondary but smaller height.
   */
  ...
  private static JButton buildRoundedButton(
      String text, Color bg, Color fg, Color borderCol, int arc, int height) {
