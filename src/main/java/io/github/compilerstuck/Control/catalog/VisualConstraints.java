 ...
 */
public record VisualConstraints(boolean requiresPerfectSquare, boolean requiresPerfectCube,
    ...
    /**
     * Proposes a valid array size for the given current size, or empty if the
     * current size already satisfies (or has no) constraints.
     */
